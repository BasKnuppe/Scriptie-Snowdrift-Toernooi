...
class MoralityCalculator(object):
    ...
    def calculate_cooperation_stuff(self):
        ...
        coop_matrix = [[0 for _ in range(num_bots)] for _ in range(num_bots)]
        big_man_scores = {}
                ...
                for meeting in interactions:
                    for turn in meeting:
                        ...
                        if turn[0] == 'C' and turn[1] == 'C':
                            bot1_coops += 1.0
                            bot2_coops += 1.0
                        if turn[0] == 'C' and turn[1] == 'D':
                            bot1_coops += 1.0
                            bot2_coops -= 0.5
                        if turn[0] == 'D' and turn[1] == 'C':
                            bot2_coops += 1.0
                            bot1_coops -= 0.5
    ...
    def principle_eigenvector(self, C, iters):
        ...
        """
        num_vals = len(C)
        current_vals = np.array([1 for _ in range(num_vals)])
        i = 0
        while i < iters:
    ...
    def calculate_network_morality(self):
        ...
        #print(self.cooperation_matrix-0.5)
